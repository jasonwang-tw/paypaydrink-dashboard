<template>
  <div id="footerBar" class="border-t border-lightblue-placeholder">
    <div class="max-w-3xl m-auto py-10 text-center text-main-500">
      ...
      <div class="pt-5">
        <router-link
          ...
          :key="index"
          :to="item.link"
          class="no-underline hover:text-blue-100 px-3"
      ...
      <div class="content block lg:flex justify-between p-5 lg:p-0 text-main-500">
        <div class="us block sm:flex text-left">
          <h5 class="mr-10 text-subyellow-500 mb-5">聯絡我們</h5>
          <ul class="list-none pl-0 text-left">
            <li>台北市中山區中山北路三段92號5樓</li>
            <li>
              <a href="mailto:evan@wiidreamthinker.com" class="hover:text-blue-100"
                >service@wiidreamthinker.com</a
              >
            </li>
            <li>
              <a href="tel:0965177683" class="hover:text-blue-100">0965-177-683</a>
            </li>
          </ul>
        </div>
        <div class="social block sm:flex lg:mt-0 mt-10 text-left text-main-500">
          <h5 class="mr-10 text-subyellow-500 mb-5">Follow US</h5>
          <ul class="list-none pl-0 flex">
            <li class="px-3">
              <a href="#" class="no-underline hover:text-blue-100"
